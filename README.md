...
| 更新时间   | 修改人  | 说明                                     | 备注                                                                                                                                                                                                                                                            |
| ---------- | ------- | ---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2025/08/05 | tanglin | 3.2 节目通用接口<br>4 API接口说明（xml） | effect节点新增闪烁特效<br> 补充支持型号：<br>常规系列 (ARM/Linux平台)： C16L, C08L, D16, D36, ...<br>安卓系列 (Android平台)： A3L, A4L, A5L, A6L, H4K, H8, B8L, A7, A8, ... <br> 安卓系列需要升级最新固件 |
